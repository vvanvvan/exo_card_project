...
class layPage extends StatefulWidget {
  @override
  _layPage createState() => _layPage();
}

class _layPage extends State<layPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/4_lay/$item', fit: BoxFit.contain, color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarlay.jpg"),
                      ),
                    ),
                    title: Text('${getData[3].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[3].date}\nHeight: ${getData[3].height}\nWeight: ${getData[3].weight}\nBlood type: ${getData[3].blood_type}',
