...
class pcyPage extends StatefulWidget {
  @override
  _pcyPage createState() => _pcyPage();
}

class _pcyPage extends State<pcyPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/6_pcy/$item', fit: BoxFit.contain, color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarpcy.jpg"),
                      ),
                    ),
                    title: Text('${getData[5].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[5].date}\nHeight: ${getData[5].height}\nWeight: ${getData[5].weight}\nBlood type: ${getData[5].blood_type}',
