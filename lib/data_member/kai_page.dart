...
class kaiPage extends StatefulWidget {
  @override
  _kaiPage createState() => _kaiPage();
}

class _kaiPage extends State<kaiPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/8_kai/$item', fit: BoxFit.contain, color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarkai.jpg"),
                      ),
                    ),
                    title: Text('${getData[7].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[7].date}\nHeight: ${getData[7].height}\nWeight: ${getData[7].weight}\nBlood type: ${getData[7].blood_type}',
