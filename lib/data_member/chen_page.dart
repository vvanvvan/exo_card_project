...
class chenPage extends StatefulWidget {
  @override
  _chenPage createState() => _chenPage();
}

class _chenPage extends State<chenPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/5_chen/$item', fit: BoxFit.contain,color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarchen.jpg"),
                      ),
                    ),
                    title: Text('${getData[4].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[4].date}\nHeight: ${getData[4].height}\nWeight: ${getData[4].weight}\nBlood type: ${getData[4].blood_type}',
