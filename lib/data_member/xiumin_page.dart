...
class xiuminPage extends StatefulWidget {
  @override
  _xiuminPage createState() => _xiuminPage();
}

class _xiuminPage extends State<xiuminPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/2_xiumin/$item', fit:BoxFit.contain, color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarxiumin.jpg"),
                      ),
                    ),
                    title: Text('${getData[1].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[1].date}\nHeight: ${getData[1].height}\nWeight: ${getData[1].weight}\nBlood type: ${getData[1].blood_type}',
