...
class sehunPage extends StatefulWidget {
  @override
  _sehunPage createState() => _sehunPage();
}

class _sehunPage extends State<sehunPage> {
  late int _position;
        ...
        children: [
          ...
          CarouselSlider(
            ...
            items: img_crs.map((item) {
              return GridTile(
                child: Image.asset('assets/images/carousel/9_sehun/$item', fit: BoxFit.contain,color: Colors.black.withOpacity(0.3), colorBlendMode: BlendMode.darken,),
                footer: Container(
                ...
                children: [
                  ...
                  ListTile(
                    leading: Container(
                      ...
                      child: CircleAvatar(
                        backgroundImage: AssetImage("assets/images/avatar_image/avatarsehun.jpg"),
                      ),
                    ),
                    title: Text('${getData[8].stagename}',
                  ...
                  ListTile(
                    subtitle: Text(
                      'Birthdate: ${getData[8].date}\nHeight: ${getData[8].height}\nWeight: ${getData[8].weight}\nBlood type: ${getData[8].blood_type}',
